...
const testimonials = [
  {
    quote: "The platform is incredibly smooth for managing my digital assets and landing pages.",
    name: "Sarah Chen",
    role: "Product Designer",
    image: "https://i.pravatar.cc/100?img=1",
  },
  {
    quote: "It helped me organize and distribute my creative resources in one place.",
    name: "Marcus Williams",
    role: "Independent Creator",
    image: "https://i.pravatar.cc/100?img=2",
  },
  {
    quote: "Clean UI and great developer experience. Everything just works.",
    name: "Emma Rodriguez",
