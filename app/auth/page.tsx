...
// // import { Mail, Lock, User, Eye, EyeOff, Check, Zap, Download, Star } from "lucide-react"
...
// //               &#9670;
// //             </span>
// //             <span className="font-display text-4xl font-extrabold text-white" style={{ fontFamily: "'Syne', sans-serif" }}>Digital</span>
// //             <span
...
// //           >
// //             Your creative <span className="text-gradient">marketplace.</span>
// //           </h1>
// //           <p className="text-[#94A3B8] text-xl mb-14" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
// //             Join thousands of creators buying and selling premium digital products.
// //           </p>

// //           {/* Floating Cards Mockup */}
// //           <div className="relative h-[220px] mb-14">
// //             {[0, 1, 2].map((i) => (
// //               <div
// //                 key={i}
...
// //                   border: `1px solid ${["#3B82F6", "#06B6D4", "#10B981"][i]}30`,
// //                   borderRadius: "16px",
// //                   width: "200px",
// //                   left: `${i * 70}px`,
// //                   top: `${i * 35}px`,
...
// //                     }30, ${["#06B6D4", "#10B981", "#F59E0B"][i]}15)`,
// //                   }}
// //                 />
// //                 <div className="h-2.5 w-3/4 rounded-full bg-white/20 mb-2" />
...
// //             {[
// //               { icon: Zap, text: "500+ premium products", color: "#3B82F6" },
// //               { icon: Download, text: "Instant download access", color: "#06B6D4" },
// //               { icon: Star, text: "Lifetime license included", color: "#F59E0B" },
...
// //                 </div>
// //                 <span className="text-white font-semibold text-lg" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>{text}</span>
// //               </div>
// //             ))}
// //           </div>
// //         </div>
...
// //           {/* Tab Toggle */}
// //           <div
// //             className="flex mb-10 p-1.5 rounded-xl"
...
// //                     <Mail size={20} className="absolute left-5 top-1/2 -translate-y-1/2 text-[#94A3B8]" />
// //                     <input
// //                       type="email"
...
// //                 <div className="mb-6">
// //                   <div className="relative">
// //                     <Lock size={20} className="absolute left-5 top-1/2 -translate-y-1/2 text-[#94A3B8]" />
// //                     <input
// //                       type={showPassword ? "text" : "password"}
// //                       placeholder="Password"
// //                       value={formData.password}
// //                       onChange={(e) => setFormData({ ...formData, password: e.target.value })}
// //                       className="input-glass w-full pl-14 pr-14 py-5 text-lg"
// //                       style={{ fontFamily: "'Space Grotesk', sans-serif" }}
// //                       required
// //                     />
// //                     <button
...
// //                       className="absolute right-5 top-1/2 -translate-y-1/2 text-[#94A3B8] hover:text-[#3B82F6] transition-colors"
// //                     >
...
// //                   style={{ fontFamily: "'Syne', sans-serif" }}
// //                 >
// //                   Join <span className="text-gradient">DigitalStore</span>
// //                 </h2>
// //                 <p className="text-[#94A3B8] mb-10 text-lg" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
...
// //                 <div className="mb-6">
// //                   <div className="relative">
// //                     <User size={20} className="absolute left-5 top-1/2 -translate-y-1/2 text-[#94A3B8]" />
// //                     <input
// //                       type="text"
...
// //                     </Link>{" "}
// //                     and{" "}
// //                     <Link href="#" className="text-[#06B6D4] hover:underline font-semibold">
// //                       Privacy Policy
// //                     </Link>
// //                   </span>
// //                 </label>
