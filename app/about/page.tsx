...
const milestones = [
  {
    year: "2019",
    title: "The Spark",
    desc: "Aryan couldn't find quality design assets without drowning in junk stores. So he built one — from a tiny Bangalore apartment with 12 hand-picked products.",
    color: "#3B82F6",
  },
  {
    year: "2020",
